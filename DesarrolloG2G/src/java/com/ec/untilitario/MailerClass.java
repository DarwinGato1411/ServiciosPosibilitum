...
import com.evintia.utils.EmailUtils;
...
public class MailerClass {
    ...
    public static Tipoambiente amb = new Tipoambiente();
...
//            amb = servicioTipoAmbiente.FindALlTipoambiente();
            System.out.println("amb.getAmUsuarioSmpt() " + amb.getAmUsuarioSmpt());
            System.out.println("amb.getAmUsuarioSmpt() " + amb.getAmPassword());
...
//                    InternetAddress.parse(address));
    public boolean sendMailSimple(String address, String mensaje,
            String[] attachFiles, String asuntoInf, String acceso, Tipoambiente ambiente)
            throws java.rmi.RemoteException {
...
//            Address addressfrom = new InternetAddress(usuarioSmpt);
            ...
            String HTMLENVIO = "<body style=\"color: #666; font-size: 14px; font-family: 'Open Sans',Helvetica,Arial,sans-serif;\">\n"
                    ...
                    + "		 DOCUMENTO ELECTRONICO " + ambiente.getAmNombreComercial().toUpperCase() + "</strong></div>\n"
...
//                    + "			  <td style=\" font-size:9px\">Copyright © 2020 TUCONTADOR.EC, All rights reserved.</td>\n"
//                    + "\n"
//                    + "			 </tr>\n"
//                    + "			 <tr style=\" background: #fafafa; color: #333; border-bottom: 1px solid #eee;;font-size:7px\n"
//                    + "				align-items: center;display: flex;justify-content: center;\">\n"
//                    + "			  <td style=\" font-size:9px\">TUCONTADOR.EC - Tlf. 0993530018</td>\n"
//                    + "\n"
//                    + "			 </tr>\n"
//                    + "\n"
//                    + "			  <tr style=\" background: #fafafa; color: #333; border-bottom: 1px solid #eee;;font-size:7px\n"
...
//             t.connect();
    ...
    public boolean sendMailNotificacion(String address, String mensaje, String asuntoInf,
            String acceso)
            throws java.rmi.RemoteException {
        ...
        try {
            ...
            texto.setContent("<h4>Documento no autorizado</h4><br>"
                    + "<table>\n"
                    + " <tr>\n"
                    + "	<td colspan='2'><h1>" + mensaje + "</h1></td>\n"
                    + "</tr>\n"
                    + "	<td colspan='2'><h2>Documento no procesado</h2></td>\n"
                    + "</tr>\n"
                    + " <tr>\n"
